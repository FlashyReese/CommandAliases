...
public class CommandAliasesLoader {
    ...
    public CommandAliasesLoader() {
        CommandRegistrationCallback.EVENT.register(this::registerCommandAliasesCommands);
        ServerLifecycleEvents.SERVER_STARTED.register((server -> this.registerCommands(server.getCommandManager().getDispatcher(), server.isDedicated())));
    }
