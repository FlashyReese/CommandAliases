...
public class ServerCustomCommandBuilder extends AbstractCustomCommandBuilder<ServerCommandSource> {
    ...
    protected String formatString(CommandContext<ServerCommandSource> context, List<String> currentInputList, String string) {
        ...
        if (context.getSource().getEntity() != null) {
            string = string.replace("$executor_name().pos_x()", String.valueOf(context.getSource().getEntity().getBlockPos().getX()));
            string = string.replace("$executor_name().pos_y()", String.valueOf(context.getSource().getEntity().getBlockPos().getY()));
            string = string.replace("$executor_name().pos_z()", String.valueOf(context.getSource().getEntity().getBlockPos().getZ()));
