...
* [Command Modes](command-modes.md)
  ...
  * [Custom](command-modes/custom/README.md)
    * [Authoring Custom Commands](command-modes/custom/authoring-custom-commands.md)
    * [Placeholders and Formatting](command-modes/custom/placeholders-and-formatting.md)
